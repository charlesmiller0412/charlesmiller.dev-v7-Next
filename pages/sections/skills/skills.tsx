        ...
        <section className="skills" id="skills">
            ...
            <div className="skills__container grid grid-cols-1 tablet:grid-cols-2 desktop:grid-cols-3 gap-y-20 place-items-center">
                ...
                <SkillsCard
                    ...
                    text="What’s the point of having a website if no one can find it? I use my research skills to determine the best tags and meta data to store in your files and put you at the top of the search results."
                />
            </div>
        </section>
    );
