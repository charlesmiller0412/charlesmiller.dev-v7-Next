    ...
    return (
        ...
        >
            <input
                ...
                placeholder="Name"
                required
                className="col-span-1 pl-[2rem] py-[1.5rem] border border-[#a1dcf0a2] bg-offWhite dark:bg-offBlack focus:outline-lightBlue"
            />
            <input
                type="tel"
                name="from_phone"
            ...
            <input
                ...
                required
                className="col-span-2 pl-[2rem] py-[1.5rem] border border-[#a1dcf0a2] bg-offWhite dark:bg-offBlack focus:outline-lightBlue"
            />
            <textarea
                name="message"
